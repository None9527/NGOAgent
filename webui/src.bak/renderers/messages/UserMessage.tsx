    ...
    <>
      ...
      <div className="w-full flex justify-end mt-4 md:mt-12 mb-4 md:mb-8 relative group/usermsg">
        <div className="flex flex-col items-end max-w-[90%] md:max-w-[75%]">
          ...
          <div className="absolute -top-5 right-1 opacity-0 group-hover/usermsg:opacity-100 transition-opacity">
            <button
              type="button"
              onClick={() => {
              ...
              className="px-1.5 py-0.5 text-[11px] text-gray-500 hover:text-gray-300 bg-white/[0.04] hover:bg-white/[0.08] rounded border border-white/[0.06] transition-all cursor-pointer"
              title="复制消息"
            >

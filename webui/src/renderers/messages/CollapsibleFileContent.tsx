...
const CollapsibleFileReference: FC<CollapsibleFileReferenceProps> = ({
  ...
  return (
    <div
      className="rounded-md overflow-hidden bg-white/[0.02] border border-white/[0.1]"
    >
      <button
        type="button"
      ...
      {isExpanded && (
        <div className="py-2 px-2.5 text-xs leading-normal bg-black/20 border-t border-white/[0.1]">
          <MessageContent

...
export const IntelligenceHub: React.FC<IntelligenceHubProps> = ({
  ...
  return (
    <div className="w-[420px] shrink-0 h-full relative bg-black/40 backdrop-blur-[60px] border-l border-white/[0.06] shadow-[-30px_0_60px_-15px_rgba(0,0,0,0.6)] z-40 flex flex-col"
         style={{ animation: 'slideInRight 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
         
      {/* Segmented Control Header - Hides when drilled down */}
      <div className={`transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden shrink-0 ${isDrilledDown ? 'h-0 opacity-0 mb-0' : 'h-[114px] opacity-100 mb-0'}`}>
